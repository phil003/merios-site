...
Apolipoprotein B is the structural protein on every atherogenic (artery-clogging) lipoprotein particle. One ApoB molecule sits on the surface of every LDL, VLDL, IDL, and Lp(a) particle. That means your ApoB level is essentially a **particle count** — a direct measurement of how many potentially dangerous lipoproteins are circulating in your blood. If your lab used different units, the free [Lp(a) unit converter](/tools/lpa-unit-converter) shows the equivalent range.
...
- **Metabolic syndrome** — [high triglycerides](/blog/how-to-lower-triglycerides) drive the liver to produce more small, dense LDL particles
...
| **ACC moderate risk** | [Below 90 mg/dL](/blog/apob-90-borderline) |
...
Lifestyle alone can lower ApoB by 10-25% in many people. For those starting very high or with genetic predisposition ([familial hypercholesterolemia](/blog/ldl-cholesterol-high-healthy-diet)), lifestyle alone is often not enough.

### Medications

- **Statins** — the first-line treatment, though they carry [side effects worth weighing](/blog/statins-side-effects-when-to-stop). Lower ApoB by 30-50% depending on the statin and dose.
...
| **Lp(a)** | [Genetically determined, independent risk factor](/blog/lp-a-lipoprotein-a-high) — test once |
...
| **hsCRP** | [Inflammatory marker](/blog/understanding-crp-inflammation) that adds context to lipid risk |
| **Fasting insulin** | Metabolic context for your lipid pattern |

## How Merios helps

Upload your lipid panel PDF to Merios and we parse ApoB, LDL-C, HDL-C, triglycerides, and Lp(a) automatically. Track your ApoB trend over time — before and after dietary changes, before and after starting a statin — and see it alongside your [resting heart rate](/blog/resting-heart-rate-suddenly-high) and HRV from Apple Watch. Cardiovascular risk is not a single snapshot; it is a trajectory.
