...
If you own an Apple Watch, you've probably noticed a metric called HRV lurking in the Health app: a number that fluctuates daily, sometimes wildly. You might have no idea what it means. If you are weighing a wearable-linked lab panel against a standalone one, [WHOOP Advanced Labs versus Function Health](/compare/whoop-advanced-labs-vs-function-health) compares them on price, marker count and who reviews the results.

[HRV—heart rate variability](/blog/heart-rate-variability-explained)—is one of the most powerful biomarkers of health, yet one of the least understood by people who measure it.
...
**What HRV is NOT useful for**: Making day-to-day decisions. One low reading is noise. Three consecutive low readings with other signs (fatigue, poor sleep, [elevated resting heart rate](/blog/resting-heart-rate-suddenly-high)) is a signal worth investigating.
...
7-9 hours consistently. [Sleep is non-negotiable for HRV](/blog/deep-sleep-how-to-increase).

### Aerobic Exercise
150 minutes/week of [moderate-intensity cardio](/blog/zone-2-cardio-heart-rate) (brisk walking, jogging, cycling) improves parasympathetic tone. High-intensity interval training (HIIT) can temporarily lower HRV but improves it long-term with proper recovery.
