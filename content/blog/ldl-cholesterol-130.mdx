...
**No, LDL 130 mg/dL is not high — it's in the "near optimal" range.** However, LDL alone tells an incomplete story. Your actual heart disease risk depends on ApoB, HDL, triglycerides, family history, and inflammation markers. Don't panic, but don't ignore it either. Other guidelines are stricter, treating the same number as [borderline-high LDL](/blog/ldl-130-borderline) — so context matters more than the label.
...
**[ApoB (apolipoprotein B)](/blog/apob-heart-disease-risk):** This measures the *number* of atherogenic particles (particles that can cause atherosclerosis). You can have LDL of 130 with a healthy ApoB (low particle count, large particles) or a concerning ApoB (many small, dense particles). ApoB &lt;70 mg/dL is optimal.
...
**[Triglyceride-to-HDL ratio](/blog/triglyceride-hdl-ratio-calculator):** Divide your triglycerides by your HDL. A ratio below 2 is healthy; above 4 suggests high risk.
...
**Inflammation markers:** High-sensitivity C-reactive protein (hsCRP) or [lipoprotein(a) (Lp(a))](/blog/lp-a-lipoprotein-a-high) can indicate cardiovascular risk independent of LDL.
...
1. **Ask for a complete lipid panel:**
   ...
   - [hsCRP (inflammation marker)](/blog/understanding-crp-inflammation)
...
5. **Consider [a statin](/blog/statins-side-effects-when-to-stop) if:**
