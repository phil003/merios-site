---
title: "Fasting Before a Blood Test: How Long, and What Breaks It"
description: "How long to fast before blood work, which tests actually need it, and exactly what breaks a fast — water, medications, gum, and toothpaste included."
date: "2026-03-26"
...
Your doctor says to fast before your 8 a.m. blood test. You set an alarm for 7:45 a.m., your stomach is growling, and you're standing in the bathroom with a question: how long does this actually have to last, and what am I allowed to have?

(If your question is specifically about coffee, that one has its own answer — see [can you drink coffee before a blood test](/blog/can-you-drink-coffee-before-blood-test), which covers black coffee, accidental sips, and the tests it actually changes.)
...
- **[Fasting glucose](/blog/fasting-glucose-100-borderline)** (blood sugar) — Requires 8 hours minimum. Any carbohydrate or sugar raises glucose; fasting gives a true baseline.
- **[Fasting insulin](/blog/fasting-insulin-levels-chart)** — Requires 8 hours. Used to assess insulin resistance. Eating stimulates insulin secretion immediately.
...
- **[Complete blood count (CBC)](/blog/cbc-blood-test-results-explained)** — Measures red blood cells, white blood cells, platelets, hemoglobin. Food doesn't affect these.
- **Hemoglobin A1C (HbA1c)** — Measures [average blood sugar over 3 months](/blog/a1c-to-blood-sugar-chart). Unaffected by yesterday's meals.
...
**Black coffee or black tea** — This is where opinions diverge. Technically, a small amount of [black coffee](/blog/does-coffee-break-a-fast) (no milk, no sugar) has negligible calories and shouldn't raise blood glucose or triglycerides. Some studies show it doesn't affect glucose tolerance tests.
