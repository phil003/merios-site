...
**Price examples:** Basic Health Profile $69, Comprehensive Metabolic Panel $29, Testosterone $49, Lipid Panel $39. For what the best-known option actually costs all-in, see [what Function Health costs in 2026](/compare/function-health-cost).
...
| **HbA1c** | 3-month average blood sugar — [screens for pre-diabetes](/blog/hba1c-5-7-pre-diabetic) |

### Tier 2: The full picture ($100-200 more)

| Test | What it covers |
|---|---|
| **ApoB** | [Atherogenic particle count](/blog/apob-heart-disease-risk) — better than LDL alone |
| **hsCRP** | Systemic inflammation marker |
| **Fasting insulin** | Insulin resistance — [catches metabolic problems early](/blog/fasting-insulin-levels-chart) |
| **TSH + Free T4** | Thyroid screening |
| **Vitamin D (25-OH)** | [Deficiency is extremely common](/blog/vitamin-d-deficiency) |
...
- **[Fast 12-14 hours](/blog/fasting-before-blood-test)** before the draw (water is fine, no coffee)
...
This is where most people get stuck. You have 30 numbers on a PDF and no idea [what any of them mean](/blog/how-to-read-blood-test-results).
