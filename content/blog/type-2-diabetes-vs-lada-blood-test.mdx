...
Type 2 diabetes is far more common than LADA — roughly 90-95% of all diabetes cases are type 2. Clinically, this creates a base-rate bias: when you see an adult with [elevated fasting glucose](/blog/fasting-glucose-110), the statistical likelihood that it's type 2 is very high.
...
Insulin resistance markers ([HOMA-IR](/blog/homa-ir-insulin-resistance), [fasting insulin](/blog/fasting-insulin-levels-chart)) help too. LADA patients typically have *low* insulin resistance — their problem isn't that their cells ignore insulin, it's that they don't have enough insulin because their beta cells are dying. Type 2 patients, by contrast, have high HOMA-IR and elevated fasting insulin (in the early stages).

## Typical LADA Presentation

A realistic LADA case: A 42-year-old woman, BMI 23, comes in for a physical. Her fasting glucose is 118 mg/dL, [A1C is 7.2%](/blog/a1c-to-blood-sugar-chart). She's not overweight, exercises regularly, has good lipids. Her doctor prescribes metformin and tells her it's "type 2." Run your own number with the free [A1C to blood sugar calculator](/tools/a1c-calculator).
...
- Screen for other autoimmune conditions ([thyroid disease](/blog/full-thyroid-panel-test), celiac disease, pernicious anemia)
