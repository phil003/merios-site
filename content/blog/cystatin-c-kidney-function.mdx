...
**Cystatin C** solves this problem. It is a small protein produced at a near-constant rate by every nucleated cell in the body, freely filtered by the kidneys, and — crucially — not affected by muscle mass, sex, or diet. This makes it a more accurate and equitable measure of kidney filtration. If you have both values, the free [sarcopenia index calculator](/tools/sarcopenia-index-calculator) turns them into a rough muscle-mass proxy.
...
- **Creatinine**: a waste product of muscle metabolism, filtered by the kidneys. The [traditional marker](/blog/creatinine-1-2-normal).
...
- **Anemia develops** — the kidneys produce erythropoietin (EPO), essential for [red blood cell production](/blog/hematocrit-levels-high-low-meaning)
- **Bone health declines** — the kidneys [activate vitamin D](/blog/vitamin-d-deficiency) and regulate calcium/phosphate balance
...
- **[Uric acid](/blog/uric-acid-levels-high)** — hyperuricemia damages renal tubules

## How to protect kidney function

- **Control blood pressure** — target below 120/80 mmHg
- **Manage blood sugar** — keep [HbA1c below 5.7%](/blog/hba1c-5-7-pre-diabetic), fasting insulin low
...
This gap matters most when your body composition is changing fast. Because creatinine comes from muscle, losing muscle produces less of it — so a creatinine-based eGFR can drift *upward*, making kidney function look like it is improving when muscle mass is actually falling. That trap, and the creatinine-to-cystatin-C ratio some use as a rough muscle proxy, is covered in [GLP-1 muscle loss and what your labs really show](/blog/glp-1-muscle-loss-peptides).
