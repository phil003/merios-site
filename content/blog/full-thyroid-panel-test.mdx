...
This is the pattern that gets dismissed. [TSH is 3.2](/blog/tsh-level-3) (within range), free T4 is fine, but your TPO antibodies are 250+ IU/mL. Your immune system is attacking your thyroid, but the gland is compensating — for now. Symptoms are present but your labs look "normal."
...
[A TSH of 3.8](/blog/tsh-4-5-normal-or-high) is "in range" but is not the same as a TSH of 1.2. Context matters.

## Nutrients that support thyroid function

- **Selenium** — 200 mcg/day has been shown to reduce [TPO antibodies in Hashimoto's patients](/blog/anti-tpo-antibodies-high-hashimotos). Brazil nuts are the richest food source.
...
- **Iron** — thyroid peroxidase (the enzyme that makes thyroid hormones) requires iron as a cofactor. [Iron deficiency](/blog/ferritin-30-low-normal) and hypothyroidism frequently coexist.
- **Vitamin D** — [low vitamin D](/blog/vitamin-d-deficiency) is associated with higher rates of thyroid autoimmunity.
