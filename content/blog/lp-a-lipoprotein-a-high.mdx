...
description: "Lp(a) is a largely genetic heart-risk factor 1 in 5 people carry high. What high Lp(a) means, why it's tested once, and how to manage the risk."
date: "2026-04-17"
...
It is called **lipoprotein(a)** — written as Lp(a) and pronounced "L-P-little-a." If your lab used different units, the free [Lp(a) unit converter](/tools/lpa-unit-converter) shows the equivalent range.
...
- **[Get ApoB as low as possible](/blog/apob-heart-disease-risk)** — this is where statins, ezetimibe, and PCSK9i make a difference
- **Optimize blood pressure** — target below 120/80
- **Eliminate smoking** — zero tolerance
- **Control metabolic health** — keep HbA1c, fasting insulin, and [HOMA-IR in optimal ranges](/blog/homa-ir-insulin-resistance)
- **Reduce inflammation** — keep [hs-CRP below 1.0 mg/L](/blog/understanding-crp-inflammation) through exercise, diet, and stress management
- **Exercise regularly** — 150+ minutes of [zone 2 cardio](/blog/zone-2-cardio-heart-rate) per week

### Step 3: Consider advanced imaging

If your Lp(a) is high, a **[coronary artery calcium (CAC) score](/blog/cac-score-coronary-calcium-scan)** can tell you whether plaque has already accumulated. This helps quantify actual risk beyond the blood number.
