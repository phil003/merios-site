---
title: "Oral Iron Supplements Not Working? Here's Why (and What to Do Instead)"
description: "Taking iron but ferritin won't budge? Why iron supplements fail — absorption blockers, wrong form, inflammation — and the evidence-based fixes that work."
date: "2026-04-16"
...
This is one of the most common stories in the iron deficiency world — and almost always, the problem is not that "iron doesn't work for me." The problem is **how** and **what** you are taking, or something else going on underneath. Oral iron *does* work for the large majority of people; it just has to clear six specific hurdles first. Here they are, in the order worth checking.
...
If you suspect inflammatory iron trapping, ask for: **hsCRP, ferritin, serum iron, TIBC, and transferrin saturation**. A pattern of normal-to-high ferritin with low transferrin saturation and elevated CRP points to inflammation rather than true deficiency. You can compute yours with the free [transferrin saturation calculator](/tools/transferrin-saturation-calculator).
...
*Related: [Ferritin level 15](/blog/ferritin-level-15) · [Ferritin 30 (low-normal)](/blog/ferritin-30-low-normal) · [Low ferritin, normal hemoglobin](/blog/low-ferritin-normal-hemoglobin) · [Lactoferrin for iron absorption](/blog/lactoferrin-iron-absorption-supplement) · [Iron supplements before testing](/blog/blood-tests-before-starting-supplements)*
