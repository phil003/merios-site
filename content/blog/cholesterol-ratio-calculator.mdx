...
**ApoB** [directly counts atherogenic particles](/blog/apob-heart-disease-risk). One ApoB protein sits on each LDL, VLDL, IDL, and Lp(a) particle. An ApoB below 90 mg/dL (conservative) or below 60 mg/dL (aggressive/longevity-focused) is the current gold standard for cardiovascular risk assessment.
