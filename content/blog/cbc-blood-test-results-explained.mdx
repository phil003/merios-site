...
description: "Understand your CBC (complete blood count) results: normal ranges for WBC, RBC, hemoglobin, hematocrit, and platelets, and what each number means."
date: "2026-04-17"
...
## CBC normal ranges at a glance

Here is the full adult reference table. Labs vary slightly, so always read your own report's range alongside these.

| Value | Normal range (men) | Normal range (women) |
|---|---|---|
| **WBC** (white blood cells) | 4,000–11,000/µL | 4,000–11,000/µL |
| **RBC** (red blood cells) | 4.5–5.5 million/µL | 4.0–5.0 million/µL |
...
| **Platelets** | 150,000–400,000/µL | 150,000–400,000/µL |

Each of these is explained line by line below — including what a high or low value usually means.
...
**High RBC** (polycythemia): can indicate dehydration, chronic hypoxia (lung disease, sleep apnea, high altitude), smoking, or rarely polycythemia vera (a bone marrow disorder). **Low RBC** (anemia): can indicate iron deficiency, B12/folate deficiency, chronic disease, blood loss, or bone marrow problems. The red-cell indices tell you which kind of anemia it is — see [what MCV and MCH mean](/blog/mcv-mch-blood-test-meaning).
...
*Related: [Hemoglobin 14](/blog/hemoglobin-14-normal) · [Hematocrit levels explained](/blog/hematocrit-levels-high-low-meaning) · [White blood cell count](/blog/white-blood-cell-count-high-low) · [Blood test normal range chart](/blog/blood-test-results-normal-range-chart) · [How to read blood test results](/blog/how-to-read-blood-test-results)*
