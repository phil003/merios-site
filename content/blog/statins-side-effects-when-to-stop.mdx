...
4. **Net effect:** LDL cholesterol drops 30-50%, [triglycerides drop 20-30%](/blog/how-to-lower-triglycerides), HDL modestly increases
...
**Key insight:** Statins lower LDL and ApoB ([apolipoprotein B](/blog/apob-heart-disease-risk), the structural protein of atherogenic particles). The effect is dose-dependent and consistent across statin types, though some statins (atorvastatin, rosuvastatin) are more potent than others (pravastatin, simvastatin).
...
- **[Lp(a) ≥50 mg/dL](/blog/lp-a-lipoprotein-a-high)** (genetic risk factor for thrombosis and premature CAD)
- **[Coronary Artery Calcification (CAC) score ≥400](/blog/cac-score-coronary-calcium-scan)** (indicates substantial atherosclerotic burden)
...
Diet (Mediterranean, DASH, portfolio diet), exercise, weight loss, and smoking cessation [lower LDL and CVD risk](/blog/how-to-lower-cholesterol-without-medication). These work synergistically with statins but rarely eliminate need for them in high-risk individuals.
